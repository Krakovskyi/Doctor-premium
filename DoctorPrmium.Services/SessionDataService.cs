...
namespace DoctorPremium.Services
{
    public class SessionDataService : ISessionDataService
    {
        ...
        public int CreateNewSession(string sessionId, DateTime sessionStart, string ipaddress, int aspUserId)
        {
            SessionData data = new SessionData() { SessionId = sessionId, SessionStart = sessionStart, IPAddress = ipaddress, AspUserId = aspUserId };
